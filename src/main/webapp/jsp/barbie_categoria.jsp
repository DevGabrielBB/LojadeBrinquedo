...
<html>
	<head>
	    <link rel="stylesheet" type="text/css" href="/LojaDeBrinquedos/css/barbie_categoria.css">
    ...
    <div id="destaque">
	   ...
	   <h1>
    		<img alt="Nerf" src="/LojaDeBrinquedos/images/barbie.png" height="150px" width = "250px">
		</h1>
