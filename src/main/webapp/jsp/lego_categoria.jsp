...
<html>
	<head>
	    <link rel="stylesheet" type="text/css" href="/LojaDeBrinquedos/css/styles_lego_categoria.css">
	    <title>Categoria LEGO</title>
...
<body>
    ...
    <div id="destaque">
	 	...
	 	<h1>
    		<img alt="Nerf" src="/LojaDeBrinquedos/images/lego.png"   height ="100px" width = "200px">
		</h1>
